...
class BootstrapTrainTestModelTest(unittest.TestCase):
    ...
    def test_train_predict_bootstrap_libsvmnusvr(self):
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.6226308662005912, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.6728233250049881, places=4)
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.8424314108711487, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.8030845707458507, places=4)
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.846391627665469, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.8053305953883215, places=4)
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.8314352752340988, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.7834536370157068, places=4)
        ...
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.17381660619722974, places=4)
    ...
    def test_train_save_load_predict_bootstrap_libsvmnusvr(self):
        ...
        self.assertAlmostEqual(self.model.evaluate(xs, ys)['RMSE'], 0.6226308662005912, places=4)
        self.assertAlmostEqual(self.model.evaluate_bagging(xs, ys)['RMSE'], 0.6728233250049881, places=4)
        ...
        self.assertAlmostEqual(loaded_model.evaluate(xs, ys)['RMSE'], 0.6226308662005912, places=4)
        self.assertAlmostEqual(loaded_model.evaluate_bagging(xs, ys)['RMSE'], 0.6728233250049881, places=4)
    ...
    def test_train_predict_bootstrap_randomforest(self):
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.1763473935351854, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.17259954003850736, places=4)
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.15634392282439022, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.16451548220306667, places=4)
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.15634392282439027, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.16559534633792203, places=4)
        ...
        model.train(xys)
        self.assertAlmostEqual(model.evaluate(xs, ys)['RMSE'], 0.15634392282438925, places=4)
        self.assertAlmostEqual(model.evaluate_bagging(xs, ys)['RMSE'], 0.16869299073806704, places=4)
    ...
    def test_train_save_load_predict_bootstrap_randomforest(self):
        ...
        self.assertAlmostEqual(self.model.evaluate(xs, ys)['RMSE'], 0.1763473935351854, places=4)
        self.assertAlmostEqual(self.model.evaluate_bagging(xs, ys)['RMSE'], 0.17259954003850736, places=4)
        ...
        self.assertAlmostEqual(loaded_model.evaluate(xs, ys)['RMSE'], 0.1763473935351854, places=4)
        self.assertAlmostEqual(loaded_model.evaluate_bagging(xs, ys)['RMSE'], 0.17259954003850736, places=4)
    ...
    def test_train_save_load_predict_residue_bootstrap_libsvmnusvr(self):
        ...
        self.assertAlmostEqual(self.model.evaluate(xs, ys)['RMSE'], 0.6226308662005912, places=4)
        self.assertAlmostEqual(self.model.evaluate_bagging(xs, ys)['RMSE'], 0.9536184380768152, places=4)
        ...
        self.assertAlmostEqual(loaded_model.evaluate(xs, ys)['RMSE'], 0.6226308662005912, places=4)
        self.assertAlmostEqual(loaded_model.evaluate_bagging(xs, ys)['RMSE'], 0.953618377381095, places=4)
    ...
    def test_train_save_load_predict_residue_bootstrap_randomforest(self):
        ...
        self.assertAlmostEqual(self.model.evaluate(xs, ys)['RMSE'], 0.1763473935351854, places=4)
        self.assertAlmostEqual(self.model.evaluate_bagging(xs, ys)['RMSE'], 0.2771658143779744, places=4)
        ...
        self.assertAlmostEqual(loaded_model.evaluate(xs, ys)['RMSE'], 0.1763473935351854, places=4)
        self.assertAlmostEqual(loaded_model.evaluate_bagging(xs, ys)['RMSE'], 0.2771658143779744, places=4)
