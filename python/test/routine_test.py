...
class TestReadDataset(unittest.TestCase):
    ...
    def test_read_dataset(self):
        ...
        self.assertTrue('groundtruth' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('os' not in list(train_assets[0].asset_dict.keys()))
        self.assertFalse('width' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('ref_width' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('dis_width' in list(train_assets[0].asset_dict.keys()))
        self.assertFalse('height' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('ref_height' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('dis_height' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('quality_width' not in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('quality_height' not in list(train_assets[0].asset_dict.keys()))
    ...
    def test_read_dataset_qualitywh(self):
        ...
        self.assertTrue('quality_width' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('quality_height' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('resampling_type' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('quality_width' in list(train_assets[1].asset_dict.keys()))
        self.assertTrue('quality_height' in list(train_assets[1].asset_dict.keys()))
        self.assertTrue('resampling_type' in list(train_assets[1].asset_dict.keys()))
    ...
    def test_read_dataset_qualitywh2(self):
        ...
        self.assertTrue('quality_height' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('resampling_type' in list(train_assets[0].asset_dict.keys()))
        self.assertTrue('quality_width' not in list(train_assets[1].asset_dict.keys()))
        self.assertTrue('quality_height' not in list(train_assets[1].asset_dict.keys()))
        self.assertTrue('resampling_type' not in list(train_assets[1].asset_dict.keys()))
        self.assertEqual(train_assets[0].asset_dict['quality_width'], 200)
        self.assertEqual(train_assets[0].asset_dict['quality_height'], 100)
        self.assertEqual(train_assets[0].asset_dict['resampling_type'], 'bicubic')
    ...
    def test_read_dataset_basic(self):
        ...
        self.assertEqual(len(assets), 4)
        self.assertTrue('groundtruth' in list(assets[0].asset_dict.keys()))
        self.assertTrue('os' not in list(assets[0].asset_dict.keys()))
        self.assertEqual(assets[0].quality_width_height, (1920, 1080))
